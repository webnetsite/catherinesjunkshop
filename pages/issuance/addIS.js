        ...
        <form className="w-full max-w-lg" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-wrap -mx-3 mb-6">
            ...
            <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
              ...
              <input
                className="appearance-none block w-full bg-blue-200 text-blue-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                id="id" name="id" 
        ...
        <div className="fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
          <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
              ...
              <div className="font-bold bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
