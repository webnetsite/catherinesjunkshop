...
const Print_TravelOrder= ({result}) => {
  ...
  return (
      <div><Head>
      <title>Print TO Alternate Driver</title> {/* Set the title here */}
    </Head>
            ...
            <div className="mt-5 md:mt-0 md:col-span-12">
              ...
              <table style={{width:'100%'}} className="border-r-2 border-l-2 border-gray-900 ...">
                <tbody>
                  <tr>
                    ...
                    <td style={{width: '45%'}} className="align-top ... font-sans ... text-xs12"><b><u>{result[0].alternatedriver.toUpperCase()}</u></b></td>
                  ...
                  <tr>
                    ...
                    <td className="align-top ... font-sans ... text-xs12"><u>Administrative Aide VI (Driver)</u></td>
                  ...
                  <tr>
                    ...
                    <td className="align-top ... font-sans ... text-xs12"><u>{moment(result[0].date_from).format('LL')}</u></td>

                    <td className="align-top ... font-sans ... text-xs12">Return:</td>
                    <td className="align-top ... font-sans ... text-xs12"><u>{moment(result[0].date_to).format('LL')}</u></td>
                  </tr>
                  <tr>
                    <td className="align-top ... font-sans ... text-xs12">Destination:</td>
                    <td colSpan ={4} className="align-top ... font-sans ... text-xs12"><u>{result[0].destination}</u></td>
                  </tr>
                </tbody>
              </table>
              <table style={{width:'100%'}} className="border-r-2 border-l-2 border-gray-900 ...">
                <tbody>
                  <tr>
                    ...
                    <td style={{width: '70%'}} className="align-top ... font-sans ... text-xs12"><u>{result[0].purpose}</u></td>
                  </tr>
                  <tr>
              ...
              <table style={{width:'100%'}} className="border-r-2 border-l-2 border-gray-900 ...">
                <tbody>
                  ...
                  <tr>
                    <td className="align-top ... font-sans ... text-xs12"><b>{result[0].recommending.toUpperCase()}</b></td>
                    <td className="align-top ... font-sans ... text-xs12"><b>{result[0].approval.toUpperCase()}</b></td>
                  </tr>
                  <tr>
                    <td className="italic align-top ... font-sans ... text-xs12">{result[0].pos_recommending}</td>
                    <td className="italic align-top ... font-sans ... text-xs12">{result[0].pos_approval}</td>
                  </tr>
                </tbody>
              </table>
              ...
              <table style={{width:'100%'}} className="border-b-2 border-l-2 border-r-2 border-t border-gray-900 ...">
                <thead>
                  <tr>
...
export async function getServerSideProps(context) {
  ...
  SELECT travel_order.id as id,travel_order.tt_id as tt_id,
  travel_order.recommending as recommending,travel_order.approval as approval,alternatedriver.name as alternatedriver,
  travel_order.pos_recommending as pos_recommending,travel_order.pos_approval as pos_approval, trip_ticket.destination as destination
  FROM travel_order
